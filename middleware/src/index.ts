...
app.use(logger()) //แสดง log https://hono.dev/docs/middleware/builtin/logger
app.use(trimTrailingSlash()) //พิมพ์ / ตัวสุดท้ายหรือไม่พิมพ์ ก็สามารถรันได้ https://hono.dev/docs/middleware/builtin/trailing-slash
app.use(timing)
